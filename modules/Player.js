"use strict";
function Player(name, previous_username, status, friends, profile,ranks,trophies, OverallStats, ObjectiveStats, ForumStats, ProjectAresStats, BlitzStats, GhostSquadronStats) {
    this.username = name;
